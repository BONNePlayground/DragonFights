...
public class CustomControllerLandedFlame extends AbstractCustomController
{
    ...
    public void movementTick()
    {
        ...
        {
            Vec3D vec3d = new Vec3D(this.enderDragon.bv.locX() - this.enderDragon.locX(),
                0.0D,
                this.enderDragon.bv.locZ() - this.enderDragon.locZ()).d();

            double x = this.enderDragon.bv.locX() + vec3d.x * 5.0D / 2.0D;
            double z = this.enderDragon.bv.locZ() + vec3d.z * 5.0D / 2.0D;
            double y = this.enderDragon.bv.e(0.5D);
            double offset = y;
