...
package lv.id.bonne.dragonfights.v1_16_R1.entity;
...
import lv.id.bonne.dragonfights.v1_16_R1.entity.controllers.CustomControllerManager;
import lv.id.bonne.dragonfights.v1_16_R1.entity.controllers.CustomControllerPhase;
import lv.id.bonne.dragonfights.v1_16_R1.entity.controllers.ICustomController;
	...
	public void movementTick()
	{
		...
		else
		{
			...
			if (vec3d1 != null)
			{
				...
				this.bA *= 0.8F;
				this.bA = (float) ((double) this.bA + d6 * (double) idragoncontroller.getRotation());
			...
			this.by = this.intersect(this.children[0].getBoundingBox()) |
