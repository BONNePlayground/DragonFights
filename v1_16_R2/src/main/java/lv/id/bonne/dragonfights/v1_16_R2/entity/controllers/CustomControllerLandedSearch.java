    ...
    public void movementTick()
    {
        ...
        if (entityHuman != null)
        {
            ...
            else
            {
                ...
                if (f1 < 0.0F || f1 > 10.0F)
                {
                    double d0 = entityHuman.locX() - this.enderDragon.bo.locX();
                    double d1 = entityHuman.locZ() - this.enderDragon.bo.locZ();
                    double d2 = MathHelper.a(MathHelper.g(180.0D - MathHelper.d(d0, d1) * 57.2957763671875D - (double) this.enderDragon.yaw),
                        -100.0D,
                        100.0D);

                    this.enderDragon.bt *= 0.8F;
                    ...
                    this.enderDragon.bt = (float) ((double) this.enderDragon.bt + d2 * (double) (0.7F / f2 / f3));
                    this.enderDragon.yaw += this.enderDragon.bt;
                }
            }
        }
