...
public class NMSSpawnManager extends BukkitSpawnManager
{
    ...
    public <T extends Entity> Optional<T> spawn(CustomEntityRoot<T> type, Location location)
    {
        ...
        Optional<net.minecraft.server.v1_15_R1.Entity> nmsEntity = EntityTypes.a(type.getKey())
        ...
        return (Optional<T>) nmsEntity.map(net.minecraft.server.v1_15_R1.Entity::getBukkitEntity);
    }
}
