...
public class NMSEntityRegistry extends HashCustomRegistry
{
    ...
    public void applyRegister(CustomEntityRoot<? extends Entity> type)
    {
        ...
        try
        {
            Constructor<? extends net.minecraft.server.v1_16_R3.Entity> constructor =
                (Constructor<? extends net.minecraft.server.v1_16_R3.Entity>) type.getNMSClass(ServerVersion.v1_16_3).
            ...
            EntityTypes<net.minecraft.server.v1_16_R3.Entity> customEntityNMSEntityType =
                EntityTypes.Builder.a(nmsCreator, nmsCreatureType).a(type.getKey());

            IRegistry.a(IRegistry.ENTITY_TYPE,
                type.getBaseID(ServerVersion.v1_16_3),
                type.getKey(),
                customEntityNMSEntityType);

            //Is an insentient entity? Also copy the EntityPositionTypes value.
            if (EntityInsentient.class.isAssignableFrom(type.getNMSClass(ServerVersion.v1_16_3)))
            {
