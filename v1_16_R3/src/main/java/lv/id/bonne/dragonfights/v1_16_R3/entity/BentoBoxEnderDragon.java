...
package lv.id.bonne.dragonfights.v1_16_R3.entity;
...
import lv.id.bonne.dragonfights.v1_16_R3.entity.controllers.CustomControllerManager;
import lv.id.bonne.dragonfights.v1_16_R3.entity.controllers.CustomControllerPhase;
import lv.id.bonne.dragonfights.v1_16_R3.entity.controllers.ICustomController;
		...
		else
		{
			...
			else
			{
				if (damageSource.getEntity() instanceof EntityHuman || damageSource.isExplosion())
				{
					...
					if (this.dl() && !this.getCustomControllerManager().getCurrentPhase().isLanded())
					{
						this.setHealth(1.0F);
	...
	private void applyKnockBack(List<Entity> list)
	{
		...
		while (iterator.hasNext())
		{
			...
			if (entity instanceof EntityLiving)
			{
				...
				if (!this.getCustomControllerManager().getCurrentPhase().isLanded() && ((EntityLiving) entity).da() < entity.ticksLived - 2)
				{
